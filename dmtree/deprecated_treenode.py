...
#     def append(self, subnode) -> None:
#         self.children.append(subnode)

#     def extend(self, subnodes) -> None:
#         self.children.extend(subnodes)

#     def insert(self, index: int, subnode) -> None:
...
#     def findall(self, match: str) -> List:
#         result = []
#         for node in self.children:
#             if node.tag == match:
#                 result.append(node)
...
#     def search(self, match: str, key, value):
#         for node in self.children:
#             if node.tag == match and node.attrib[key] == value:
#                 return node
#         return None

#     def searchall(self, match: str, key, value) -> List:
#         result = []
#         for node in self.children:
#             if node.tag == match and node.attrib[key] == value:
#                 result.append(node)
